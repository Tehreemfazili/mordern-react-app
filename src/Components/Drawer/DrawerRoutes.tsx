...
import AddResources from '../../Pages/Resources/AddResources/AddResources.tsx';
  ...
  return (
    <>
      <Routes>
        ...
        <Route path="/models" element={<AddResources />} />;
        <Route path="/add-resources" element={<ResourcesModal />} />;
        <Route path="/recent-events" element={<Dashboard />} />;
      </Routes>
    </>
  );
